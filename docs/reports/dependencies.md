...
```mermaid
graph TD
  tests_test_phase_a["test_phase_a"] --> repo_scan_cli["cli"]
  ...
  tests_test_visuals["test_visuals"] --> repo_scan_cli["cli"]
  ...
  tests_test_portability["test_portability"] --> repo_scan_cli["cli"]
  ...
  tests_test_tests_map["test_tests_map"] --> repo_scan_cli["cli"]
  ...
  tests_test_radar_full["test_radar_full"] --> repo_scan_cli["cli"]
  ...
  class repo_scan_cli,repo_scan_config hot
  class repo_scan_complexity,repo_scan_graphs,repo_scan_languages,repo_scan_radar_pipeline,repo_scan_radar_sources,repo_scan_ranking,repo_scan_writers,tests_test_radar_pipeline,tests_test_trends warm
  class repo_scan_radar_fetchers,repo_scan_radar_gates,repo_scan_radar_llm,repo_scan_radar_research,repo_scan_tests_map,repo_scan_trends,repo_scan_utils,tests_test_phase_a,tests_test_portability,tests_test_radar_full,tests_test_radar_gates,tests_test_radar_ingest,tests_test_radar_llm,tests_test_scan,tests_test_tests_map,tests_test_visuals cold
```
