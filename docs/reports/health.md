# Health report
_Generated 2026-06-12 14:53 UTC_  |  _Branch: main_  |  _Last commit: ddd7727 vault: scheduled scan_

> [!note] Vault provenance: 107/148 docs fully traced (72%)
...
| `tests/test_hub_ui.py` | 460 | 21.8 KB | *large* |
...
| `repo_scan/hub/ui/_css.py` | 299 | 19.3 KB | ok |
| `repo_scan/graphs.py` | 294 | 13.0 KB | ok |
| `repo_scan/hub/ui/_graph_dashboard.py` | 288 | 13.9 KB | ok |
...
| `repo_scan/hub/ui/_graph.py` | 197 | 10.2 KB | ok |
| `repo_scan/hub/ui/_graph_views2.py` | 184 | 9.0 KB | ok |
| `repo_scan/hub/ui/_graph_sim.py` | 179 | 7.3 KB | ok |
...
xychart-beta
    ...
    y-axis "Commits" 0 --> 64
    bar [64, 49, 35, 30, 23, 23, 23, 23, 23, 22]
```
...
| `docs/tickets/board.md` | 35 |
| `README.md` | 30 |
| `docs/architecture/dependency-graph.md` | 23 |
| `docs/index.md` | 23 |
| `docs/reports/calls.md` | 23 |
| `docs/reports/dependencies.md` | 23 |
| `docs/reports/health.md` | 23 |
| `docs/scan.json` | 22 |
| `docs/research/index.md` | 21 |
| `docs/research/tags.md` | 21 |
| `docs/research/candidates.md` | 20 |
...
|------|---------|---------|------------------|------------|------|
| `repo_scan/radar/act.py` | 10 | 1 | 100% | 1 | silo |
| `repo_scan/radar/llm.py` | 10 | 1 | 100% | 1 | silo |
| `pyproject.toml` | 9 | 1 | 100% | 1 | silo |
| `repo_scan/radar/research.py` | 8 | 1 | 100% | 1 | silo |
| `repo_scan/hub/state.py` | 6 | 1 | 100% | 1 | silo |
| `repo_scan/hub/prs.py` | 5 | 1 | 100% | 1 | silo |
| `repo_scan/provenance.py` | 5 | 1 | 100% | 1 | silo |
| `repo_scan/hub/graph.py` | 4 | 1 | 100% | 1 | — |
| `tests/test_prs.py` | 4 | 1 | 100% | 1 | — |
| `repo_scan/provenance_lint.py` | 3 | 1 | 100% | 1 | — |
| `repo_scan/__init__.py` | 3 | 1 | 100% | 1 | — |
| `repo_scan/digest.py` | 3 | 1 | 100% | 1 | — |
| `repo_scan/hub/agentic_loop.py` | 3 | 1 | 100% | 1 | — |
| `repo_scan/ranking.py` | 3 | 1 | 100% | 1 | — |
| `repo_scan/radar/fetchers.py` | 3 | 1 | 100% | 1 | — |
