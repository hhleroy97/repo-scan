# Health report
_Generated 2026-06-10 00:38 UTC_  |  _Branch: main_  |  _Last commit: 6942774 feat: test-presence mapping — ranking Tests column, untested candidates get 2x priority_
...
|------|-------|------|--------|
| `repo_scan/writers.py` | 406 | 16.8 KB | *large* |
...
| `repo_scan/scanner.py` | 129 | 6.1 KB | ok |
...
|------|----------|------|-------|------|
| `repo_scan/scanner.py` | `scan` | D | 24 | 43 |
| `repo_scan/writers.py` | `write_index` | D | 24 | 232 |
| `repo_scan/writers.py` | `write_health_report` | C | 20 | 105 |
...
xychart-beta
    ...
    x-axis ["dependency-graph.…", "index.md", "calls.md", "dependencies.md", "health.md", "scan.json", "scanner.py", "writers.py", "README.md", "digest.md"]
    y-axis "Commits" 0 --> 9
    bar [9, 9, 9, 9, 9, 8, 7, 6, 6, 6]
```

| File | Commits |
|------|---------|
| `docs/architecture/dependency-graph.md` | 9 |
| `docs/index.md` | 9 |
| `docs/reports/calls.md` | 9 |
| `docs/reports/dependencies.md` | 9 |
| `docs/reports/health.md` | 9 |
| `docs/scan.json` | 8 |
| `repo_scan/scanner.py` | 7 |
| `repo_scan/writers.py` | 6 |
| `README.md` | 6 |
| `docs/digest.md` | 6 |
| `docs/research/candidates.md` | 6 |
| `pyproject.toml` | 5 |
| `setup.py` | 5 |
