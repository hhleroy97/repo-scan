# Health report
_Generated 2026-06-10 00:21 UTC_  |  _Branch: main_  |  _Last commit: c5b6286 fix: emoji-free generated docs — pictographs render as tofu in Obsidian/WSL_
...
| `repo_scan/scanner.py` | 119 | 5.4 KB | ok |
...
| `tests/test_portability.py` | 29 | 1.3 KB | ok |
...
xychart-beta
    ...
    x-axis ["dependency-graph.…", "index.md", "calls.md", "dependencies.md", "health.md", "scan.json", "digest.md", "candidates.md", "README.md", "pyproject.toml"]
    y-axis "Commits" 0 --> 8
    bar [8, 8, 8, 8, 8, 7, 5, 5, 5, 5]
```

| File | Commits |
|------|---------|
| `docs/architecture/dependency-graph.md` | 8 |
| `docs/index.md` | 8 |
| `docs/reports/calls.md` | 8 |
| `docs/reports/dependencies.md` | 8 |
| `docs/reports/health.md` | 8 |
| `docs/scan.json` | 7 |
| `docs/digest.md` | 5 |
| `docs/research/candidates.md` | 5 |
| `README.md` | 5 |
| `pyproject.toml` | 5 |
| `setup.py` | 5 |
| `docs/research/index.md` | 4 |
| `docs/research/tags.md` | 4 |
| `repo_scan/writers.py` | 4 |
| `docs/research/sources/gh-yamadashy-repomix.md` | 3 |
