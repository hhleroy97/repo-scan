...
graph TD
  ...
  repo_scan_radar_gates_py --> repo_scan_radar_research_py
  repo_scan_radar_research_py --> tests_test_radar_pipeline_py
...
linkStyle 10 stroke:#95a5a6,stroke-width:1px
...
linkStyle 17 stroke:#c0392b,stroke-width:2px,stroke-dasharray: 5 5
linkStyle 18 stroke:#c0392b,stroke-width:2px,stroke-dasharray: 5 5
linkStyle 19 stroke:#95a5a6,stroke-width:1px
```

> [!warning] 6 hidden seam(s): coupled in history, no import edge
> - `repo_scan/graphs.py` ↔ `repo_scan/languages.py` (77% over 5 commits)
> - `repo_scan/hub/daemon.py` ↔ `tests/test_act.py` (62% over 8 commits)
> - `repo_scan/config.py` ↔ `repo_scan/hub/daemon.py` (59% over 10 commits)
> - `repo_scan/radar/gates.py` ↔ `tests/test_radar_pipeline.py` (56% over 5 commits)
> - `repo_scan/radar/gates.py` ↔ `repo_scan/radar/research.py` (50% over 4 commits)
...
| `repo_scan/radar/pipeline.py` | `tests/test_radar_pipeline.py` | 8 | 67% | yes |
| `repo_scan/scanner.py` | `repo_scan/writers.py` | 9 | 64% | yes |
| `repo_scan/hub/daemon.py` | `tests/test_act.py` | 8 | 62% | **none — seam** |
| `repo_scan/graphs.py` | `repo_scan/scanner.py` | 7 | 61% | yes |
| `repo_scan/config.py` | `repo_scan/hub/daemon.py` | 10 | 59% | **none — seam** |
| `repo_scan/radar/gates.py` | `repo_scan/radar/pipeline.py` | 7 | 58% | yes |
| `repo_scan/radar/gates.py` | `tests/test_radar_pipeline.py` | 5 | 56% | **none — seam** |
| `repo_scan/radar/pipeline.py` | `repo_scan/radar/research.py` | 6 | 55% | yes |
| `repo_scan/hub/server.py` | `repo_scan/hub/state.py` | 6 | 55% | yes |
...
| `repo_scan/radar/gates.py` | `repo_scan/radar/research.py` | 4 | 50% | **none — seam** |
| `repo_scan/radar/research.py` | `tests/test_radar_pipeline.py` | 4 | 50% | **none — seam** |
