# Change coupling
_Generated 2026-06-10 17:51 UTC_
...
> - `repo_scan/hub/daemon.py` ↔ `tests/test_act.py` (67% over 7 commits)
> - `repo_scan/config.py` ↔ `repo_scan/hub/daemon.py` (52% over 7 commits)
> - `repo_scan/hub/daemon.py` ↔ `tests/test_hub.py` (52% over 6 commits)
...
| `repo_scan/hub/server.py` | `repo_scan/hub/ui.py` | 10 | 83% | yes |
| `repo_scan/radar/cli.py` | `repo_scan/radar/gates.py` | 5 | 83% | yes |
| `repo_scan/tickets.py` | `tests/test_tickets.py` | 4 | 73% | yes |
| `repo_scan/hub/daemon.py` | `tests/test_act.py` | 7 | 67% | **none — seam** |
...
| `repo_scan/hub/server.py` | `repo_scan/hub/state.py` | 4 | 53% | yes |
| `repo_scan/config.py` | `repo_scan/hub/daemon.py` | 7 | 52% | **none — seam** |
| `repo_scan/hub/daemon.py` | `tests/test_hub.py` | 6 | 52% | **none — seam** |
