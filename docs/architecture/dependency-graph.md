...
```mermaid
graph TD
  tests_test_phase_a["test_phase_a"] --> repo_scan_identity["identity"]
  ...
  tests_test_visuals["test_visuals"] --> repo_scan_identity["identity"]
  ...
  tests_test_scan["test_scan"] --> repo_scan_identity["identity"]
  ...
  tests_test_radar_full["test_radar_full"] --> repo_scan_identity["identity"]
  ...
  class repo_scan_config,repo_scan_identity,repo_scan_radar_pipeline hot
  class repo_scan_graphs,repo_scan_radar_fetchers,repo_scan_radar_gates,repo_scan_radar_research,repo_scan_radar_sources,repo_scan_ranking,repo_scan_writers,tests_test_radar_pipeline warm
  class repo_scan_radar_llm,repo_scan_utils,tests_test_phase_a,tests_test_radar_full,tests_test_radar_gates,tests_test_radar_ingest,tests_test_radar_llm,tests_test_scan,tests_test_visuals cold
```
